    ...
    const fetchData = async () => {
      ...
      try {
        const res = await axios.get(
          `https://internflow-hf1d.onrender.com/api/auth/monitor`,
            ...
            <tbody>
              {interns.map(intern => (
                <tr key={intern._id} style={{ borderBottom: '1px solid #2a4a6c' }}>
                  ...
                  <td style={{ padding: '12px', color: '#22c55e' }}>{intern.attendanceCount} days</td>
                  ...
                  <td style={{ padding: '12px' }}>
                    <span style={{ background: intern.onboarded ? '#22c55e' : '#ef4444', padding: '4px 8px', borderRadius: '4px', fontSize: '12px' }}>
